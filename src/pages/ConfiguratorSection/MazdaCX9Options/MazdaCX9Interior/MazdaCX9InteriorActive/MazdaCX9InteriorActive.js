  ...
  return (
    <>
      <div className="mazdacx9-interior-main-container-active">
        ...
        <div className="mazdacx9-interior-main-container-main-part-active">
          <div className="mazdacx9-interior-main-container-main-part-panell-active">
...
export default MazdaCX9InteriorActive;
