...
import "./MazdaCX5InteriorActiveHard.css";
...
const MazdaCX5InteriorActiveHard = (props) => {
  const [hover, setHover] = useState(false);
  const onHover = () => {
    setHover(!hover);
  };

  const [type, setType] = useState("activehard");
  ...
  return (
    <>
      <div className="mazdacx5-interior-main-container-active-hard">
        <div className="mazdacx5-interior-main-container-header-active-hard">
          ...
          <Link
            ...
            className="mazdacx5-interior-main-container-header-link-active-hard"
          >
            Закрыть {hover ? <MdClose className="" /> : <MdClose />}
          </Link>
        </div>
        <div className="mazdacx5-interior-main-container-main-part-active-hard">
          <div className="mazdacx5-interior-main-container-main-part-panell-active-hard">
            <PanelliumMazdaCX5 activeButt={activeButt} type={type} />
          </div>
          <div className="mazdacx5-interior-main-container-main-part-colors-active-hard">
            <div className="colorsForPanelliumMazdacx5-container-active-hard">
...
export default MazdaCX5InteriorActiveHard;
