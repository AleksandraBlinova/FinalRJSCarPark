...
const ChosenEquipmentCX5 = (props) => {
  return (
    <>
        ...
        <span className="span-chosen-equip-container">
          <span className="span-chosen-equip">
            <span className="span-chosen-equip-img-container">
              <img src="../configurator/main-cards/4,05b3f90622f0a5.png" />
            </span>
          ...
          <span className="span-chosen-equip-button-container">
            <Link to="/extraservcx5" className="span-chosen-equip-link">
...
export default ChosenEquipmentCX5;
